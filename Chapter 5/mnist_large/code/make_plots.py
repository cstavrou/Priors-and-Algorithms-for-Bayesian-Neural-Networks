...
plt_no = int(sys.argv[6])
trace_plt = str(sys.argv[7])                # True/False
prob_trace = str(sys.argv[8])				# True/False
mar_plots = str(sys.argv[9])                # True/False
skip_first = str(sys.argv[10])              # True/False
samp100 = str(sys.argv[11])                 # True/False
if samp100 == 'True':
